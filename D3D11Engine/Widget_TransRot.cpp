...
void Widget_TransRot::DoHoverTest( HWND hw ) {
	...
	auto ColorShader = ((D3D11GraphicsEngineBase*)Engine::GraphicsEngine)->GetShaderManager().GetPShader( L"PS_Lines" );
	auto SelectedShader = ((D3D11GraphicsEngineBase*)Engine::GraphicsEngine)->GetShaderManager().GetPShader( L"PS_LinesSel" );
