...
XRESULT D3D11PfxRenderer::BlurTexture(RenderToTextureBuffer * texture, bool leaveResultInD4_2, float scale, const DirectX::SimpleMath::Vector4 & colorMod, const std::string & finalCopyShader)
{
